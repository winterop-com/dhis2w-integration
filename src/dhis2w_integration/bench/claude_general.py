...
Usage:
    uv run python -m dhis2w_integration.bench.claude_general                 # session-default model
    uv run python -m dhis2w_integration.bench.claude_general opus sonnet     # compare models
"""
...
from dhis2w_integration.bench.general import (
    CLI_SYSTEM,
    CLI_TASKS,
    PY_SYSTEM,
    PYTHON_TASKS,
