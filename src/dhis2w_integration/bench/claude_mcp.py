...
Usage:
    uv run python -m dhis2w_integration.bench.claude_mcp                 # session-default model, all rounds
    uv run python -m dhis2w_integration.bench.claude_mcp opus sonnet     # compare named models
    uv run python -m dhis2w_integration.bench.claude_mcp --runs 3        # repeat the flaky composite round
"""
...
from dhis2w_integration.bench.mcp import READ_TASKS, REPO, WRITE_TASK, _is_read_tool, _score_read
