...
Usage:
    uv run python -m dhis2w_integration.bench.longcontext google/gemma-4-26b-a4b-qat
    BENCH_CONTEXT=131072 uv run python -m dhis2w_integration.bench.longcontext <model> ...
"""
...
def _require_models() -> list[str]:
    ...
    if not requested:
        ...
        print(
            "usage: python -m dhis2w_integration.bench.longcontext <model-key> ...\ninstalled:\n  " + installed,
            file=sys.stderr,
        )
        sys.exit(2)
    return requested
