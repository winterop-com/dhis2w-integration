...
Usage:
    uv run python -m dhis2w_integration.bench.router google/gemma-4-26b-a4b-qat
    BENCH_CONTEXT=8192 uv run python -m dhis2w_integration.bench.router <model> ...
"""
...
from dhis2w_integration.bench.backend import get_backend
from dhis2w_integration.bench.mcp import READ_TASKS, REPO, _score_read
...
def main() -> None:
    ...
    if not models:
        ...
        print(
            "usage: python -m dhis2w_integration.bench.router <model-key> ...\ninstalled:\n  " + installed,
            file=sys.stderr,
        )
        sys.exit(2)
