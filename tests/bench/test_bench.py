...
from dhis2w_integration.bench import general, mcp
from dhis2w_integration.bench.backend import LmStudioBackend, ModelInfo, get_backend
...
def test_haystack_plants_needle_at_depth() -> None:
    ...
    from dhis2w_integration.bench import longcontext as lc
...
def test_longcontext_effective_context() -> None:
    ...
    from dhis2w_integration.bench.longcontext import LengthResult, ModelReport
...
async def test_claude_read_only_gate(tool_name: str, allowed: bool) -> None:
    ...
    from dhis2w_integration.bench import claude_mcp
...
async def test_claude_bridge_gate_single_tool() -> None:
    ...
    from dhis2w_integration.bench import claude_bridge
...
def test_claude_model_report_aggregates() -> None:
    ...
    from dhis2w_integration.bench.claude_mcp import ModelReport, TaskOutcome
...
def test_claude_markdown_table_has_model_and_rounds() -> None:
    ...
    from dhis2w_integration.bench.claude_mcp import ModelReport, TaskOutcome, _markdown_table
...
def test_router_bench_report_and_table() -> None:
    ...
    from dhis2w_integration.bench.mcp import READ_TASKS
    from dhis2w_integration.bench.router import ModelReport, TaskOutcome, _markdown_table
...
async def test_claude_general_gates() -> None:
    ...
    from dhis2w_integration.bench import claude_general as cg
...
def test_claude_general_table() -> None:
    ...
    from dhis2w_integration.bench.claude_general import _markdown_table, _ModelRun
    from dhis2w_integration.bench.general import ModelReport, TaskResult
